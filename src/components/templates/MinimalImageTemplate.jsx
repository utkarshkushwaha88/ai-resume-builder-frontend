                ...
                <main className="col-span-2 p-8 pt-0">
                    ...
                    {data.professional_summary && (
                        <section className="mb-8">
                            ...
                            <p className="text-zinc-700 leading-relaxed break-all">
                                {data.professional_summary}
                            </p>
                        </section>
                    )}
                    ...
                    {data.experience && data.experience.length > 0 && (
                        <section>
                            ...
                            <div className="space-y-6 mb-8 break-all">
                            ...
                            <div className="space-y-4">
                                {data.project.map((project, index) => (
                                    <div key={index}>
                                        ...
                                        {project.description && (
                                            <ul className="list-disc list-inside text-sm text-zinc-700  space-y-1 break-all">
