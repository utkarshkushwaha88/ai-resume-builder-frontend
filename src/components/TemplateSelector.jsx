...
const TemplateSelector = ({selectTemplate,onChange}) => {
    ...
    const templates = [
        ...
        {id:"minimal",name:"Minimal",preview:"Ultra-clean design tha puts your content front and center"},
                    ...
                    {templates.map((template)=>(
                        ...
                        className={`relative p-3 border rounded-md cursor-pointer transition-all ${selectTemplate === template.id ? "border-blue-400 bg-blue-100":"border-gray-300 hover:border-gray-400 hover:bg-gray-100"}`}>
                            ...
                            <div className='space-y-1'>
                                ...
                                <div
                                className='mt-2 p-2 bg-blue-50 rounded text-xs text-gray-500 italic'
